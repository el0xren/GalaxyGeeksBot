...
authorize.handler = {"type": "command", "commands": ["authorize"]}
unauthorize.handler = {"type": "command", "commands": ["unauthorize"]}
list_authorized.handler = {"type": "command", "commands": ["authorized"]}
